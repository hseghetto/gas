...
for reg2 in [0,2]:
    for layer_size in [16]:
        for epochs in [[150],[200],[250]]:
            for epochs1 in [[50],[100],[150],[200]]:
                for transition_size in [int(sys.argv[1])]:
                    for batch_size in [[32]]:
                        ...
                        for seed in range(10):
                            ...
                            trans_error = history[-1,5:8]
                            
                            print("Testing")
                            test_results, test_errors = gas.predict(data_shaped_norm[0:4406],label[0:4406],model,data_stats)
