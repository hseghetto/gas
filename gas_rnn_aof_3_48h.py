...
"""
This actually may not work properly (need to correct the aof calculation)
Traiuns on 0-48h, predicts 48-120h
                ...
                for reg2 in [0.001,0.005,0.01,0.05,0.1,0.5]:
                    for layer_size in [8,16,24,32]:
                        ...
                        for seed in range(10): #number of runs per hyperparameter set
                            ...
                            #a=a[0:index[1]]
                            a=a[index[2]-last:index[5]] #use index-last: to predict from the last point before 144h 
